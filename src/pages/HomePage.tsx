...
import { ArrowRight, Box, Layers, Cpu, Shield, ChevronDown, Play, LogIn, X, Mail, Eye, EyeOff, UserPlus, MessageCircle, Menu } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden">
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-2 sm:p-4">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-40 sm:w-80 h-40 sm:h-80 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          </div>

          <div className="relative w-full max-w-md group/modal max-h-[95vh] overflow-y-auto">
            ...
            <div className="relative backdrop-blur-xl rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.95) 0%, rgba(8, 47, 73, 0.9) 50%, rgba(15, 23, 42, 0.95) 100%)' }}>
              <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="hidden sm:block absolute top-10 left-10 w-32 h-32 border border-cyan-500/10 rounded-full" />
                <div className="hidden sm:block absolute top-8 left-8 w-36 h-36 border border-cyan-500/5 rounded-full" />
                <div className="hidden sm:block absolute bottom-10 right-10 w-24 h-24 border border-blue-500/10 rounded-full" />

                <div className="hidden sm:block absolute top-1/4 right-8 w-1 h-16 bg-gradient-to-b from-transparent via-cyan-400/30 to-transparent" />
                <div className="hidden sm:block absolute bottom-1/4 left-8 w-1 h-16 bg-gradient-to-b from-transparent via-blue-400/30 to-transparent" />
                <div className="hidden sm:block absolute top-8 left-1/4 w-16 h-1 bg-gradient-to-r from-transparent via-cyan-400/30 to-transparent" />
                <div className="hidden sm:block absolute bottom-8 right-1/4 w-16 h-1 bg-gradient-to-r from-transparent via-blue-400/30 to-transparent" />
              </div>

              <div className="absolute inset-0">
                <div className="absolute top-0 left-0 w-12 sm:w-20 h-[2px] bg-gradient-to-r from-cyan-400 to-transparent" />
                <div className="absolute top-0 left-0 w-[2px] h-12 sm:h-20 bg-gradient-to-b from-cyan-400 to-transparent" />
                <div className="absolute top-0 right-0 w-12 sm:w-20 h-[2px] bg-gradient-to-l from-cyan-400 to-transparent" />
                <div className="absolute top-0 right-0 w-[2px] h-12 sm:h-20 bg-gradient-to-b from-cyan-400 to-transparent" />
                <div className="absolute bottom-0 left-0 w-12 sm:w-20 h-[2px] bg-gradient-to-r from-cyan-400 to-transparent" />
                <div className="absolute bottom-0 left-0 w-[2px] h-12 sm:h-20 bg-gradient-to-t from-cyan-400 to-transparent" />
                <div className="absolute bottom-0 right-0 w-12 sm:w-20 h-[2px] bg-gradient-to-l from-cyan-400 to-transparent" />
                <div className="absolute bottom-0 right-0 w-[2px] h-12 sm:h-20 bg-gradient-to-t from-cyan-400 to-transparent" />
              </div>
              ...
              <button
                ...
                className="absolute top-3 right-3 sm:top-4 sm:right-4 z-50 group/close w-8 h-8 sm:w-10 sm:h-10 rounded-full transition-all duration-300 cursor-pointer overflow-hidden"
              >
              ...
              {showRegistration ? (
                ...
                <div className="p-4 sm:p-8 relative z-10">
                  <div className="text-center mb-6 sm:mb-8">
                    <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 mb-3 sm:mb-4">
                      <LogIn className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400" />
                    </div>
                    <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Connexion</span>
                    </h1>
                    <p className="text-gray-400 text-xs sm:text-sm">Accedez a votre espace personnel</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                      ...
                      <div className="relative group/input">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="block w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 bg-gray-900/80 border border-gray-700/50 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 transition-all duration-300 text-sm sm:text-base"
                    ...
                    <div>
                      ...
                      <div className="flex justify-center items-center gap-1.5 sm:gap-3 mb-4 sm:mb-5">
                        {[0, 1, 2, 3, 4, 5].map((index) => (
                          <div key={index} className="flex flex-col items-center gap-2">
                            <div className={`w-8 h-10 sm:w-10 sm:h-12 rounded-lg border ${password[index] ? 'border-cyan-500/50 bg-cyan-500/10' : 'border-gray-700/50 bg-gray-900/50'} flex items-center justify-center transition-all duration-200`}>
                              {password[index] && (
                        ...
                        <button
                          ...
                          className="w-8 h-10 sm:w-10 sm:h-12 flex items-center justify-center text-gray-400 hover:text-red-400 transition-colors disabled:opacity-30 disabled:cursor-not-allowed rounded-lg border border-gray-700/50 bg-gray-900/50 hover:border-red-500/50 hover:bg-red-500/10"
                        >
                      ...
                      <div className="grid grid-cols-5 gap-1.5 sm:gap-2 mb-4">
                        {shuffledDigits.map((digit) => (
                          <button
                            ...
                            className="group/digit relative aspect-square overflow-hidden rounded-lg sm:rounded-xl transition-all duration-200 active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed"
                          >
                            <div className="absolute inset-0 bg-gray-900/80 border border-gray-700/50 rounded-lg sm:rounded-xl group-hover/digit:border-cyan-500/50 transition-colors" />
                            ...
                            <span className="relative z-10 text-base sm:text-xl font-semibold text-gray-300 group-hover/digit:text-cyan-400 transition-colors">
                              {digit}
                            </span>
                          </button>
                        ))}
                      ...
                      <button
                        ...
                        className={`w-full text-center py-2 text-xs sm:text-sm transition-colors ${
                    ...
                    {error && (
                      <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="relative p-3 text-red-400 text-xs sm:text-sm text-center">
                          {error}
                        </div>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      className="group/submit relative w-full py-3 sm:py-4 bg-transparent overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      ...
                      <div className="relative flex items-center justify-center gap-2 sm:gap-3">
                        {isLoading ? (
                          <>
                            <div className="w-4 h-4 sm:w-5 sm:h-5 border-2 border-cyan-400/30 border-t-cyan-400 rounded-full animate-spin" />
                            <span className="text-base sm:text-lg font-semibold tracking-wider uppercase text-cyan-100">
                              Connexion...
                            </span>
                          </>
                        ) : (
                          <>
                            <div className="relative">
                              <LogIn className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 group-hover/submit:text-white transition-colors duration-300" />
                            ...
                            <span className="text-base sm:text-lg font-semibold tracking-wider uppercase text-cyan-100 group-hover/submit:text-white transition-colors duration-300">
                              Valider
                            </span>
                    ...
                    <div className="text-center">
                      ...
                      <button
                        ...
                        className="group/register inline-flex items-center gap-2 text-gray-400 hover:text-cyan-400 font-medium transition-colors text-sm sm:text-base"
                      >
                        <UserPlus className="w-4 h-4 sm:w-5 sm:h-5" />
                        <span>S'inscrire</span>
                        <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 opacity-0 -translate-x-2 group-hover/register:opacity-100 group-hover/register:translate-x-0 transition-all duration-300" />
                      </button>
                    </div>
                  </form>
                </div>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute w-[400px] sm:w-[600px] lg:w-[800px] h-[400px] sm:h-[600px] lg:h-[800px] rounded-full opacity-20"
            style={{
        ...
        <nav className="absolute top-0 left-0 right-0 z-[100] px-4 sm:px-8 py-4 sm:py-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3 relative z-[101]">
              <img src="/logo_nova_2.jpeg" alt="Novigo3D Logo" className="h-10 sm:h-12 lg:h-16 w-auto rounded-lg shadow-lg" />
            </div>
            ...
            <div className="hidden md:flex items-center gap-4 lg:gap-8">
              ...
              <a
                href="#contact"
                className="group relative px-4 lg:px-6 py-2 sm:py-2.5 bg-transparent overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-sm" />
          ...
          {mobileMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-xl border-t border-cyan-500/20 p-4">
              <div className="flex flex-col gap-4">
                <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm font-medium py-2">Fonctionnalites</a>
                <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm font-medium py-2">A propos</a>
                <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm font-medium py-2 flex items-center gap-2">
        ...
        <div className="absolute bottom-16 sm:bottom-24 left-1/2 -translate-x-1/2 z-20">
          <button
            onClick={() => setShowModal(true)}
            className="group relative px-6 sm:px-12 py-3 sm:py-5 bg-transparent overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-sm" />

            <div className="absolute inset-0">
              <div className="absolute top-0 left-0 w-6 sm:w-8 h-[2px] bg-gradient-to-r from-cyan-400 to-transparent group-hover:w-full transition-all duration-500" />
              <div className="absolute top-0 left-0 w-[2px] h-6 sm:h-8 bg-gradient-to-b from-cyan-400 to-transparent group-hover:h-full transition-all duration-500" />
              <div className="absolute bottom-0 right-0 w-6 sm:w-8 h-[2px] bg-gradient-to-l from-cyan-400 to-transparent group-hover:w-full transition-all duration-500" />
              <div className="absolute bottom-0 right-0 w-[2px] h-6 sm:h-8 bg-gradient-to-t from-cyan-400 to-transparent group-hover:h-full transition-all duration-500" />
            </div>

            <div className="absolute inset-[1px] bg-black/60 group-hover:bg-black/40 transition-colors duration-300" />

            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 sm:w-32 h-24 sm:h-32 bg-cyan-500/30 rounded-full blur-2xl" />
            </div>
            ...
            <div className="relative flex items-center gap-2 sm:gap-3">
              <div className="relative">
                <LogIn className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 group-hover:text-white transition-colors duration-300" />
                <div className="absolute inset-0 blur-sm bg-cyan-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
              <span className="text-sm sm:text-lg font-semibold tracking-wider uppercase text-cyan-100 group-hover:text-white transition-colors duration-300">
                Connexion
              </span>
        ...
        <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <ChevronDown className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400/60" />
        </div>
      </div>


      <section id="features" className="relative py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-black via-gray-950 to-black">
            ...
            {features.map((feature, index) => (
              <div
                ...
                className={`relative p-6 sm:p-8 rounded-2xl border transition-all duration-500 cursor-pointer group ${
                  activeFeature === index
                    ? 'bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border-cyan-500/50 scale-100 sm:scale-105'
                    : 'bg-gray-900/50 border-gray-800 hover:border-gray-700'
                }`}
                onMouseEnter={() => setActiveFeature(index)}
                onClick={() => setActiveFeature(index)}
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 transition-all duration-500 ${
                  activeFeature === index
                    ? 'bg-gradient-to-br from-cyan-500 to-blue-500'
                    : 'bg-gray-800 group-hover:bg-gray-700'
                }`}>
                  <feature.icon className={`w-6 h-6 sm:w-7 sm:h-7 ${activeFeature === index ? 'text-white' : 'text-cyan-400'}`} />
                </div>
      ...
      <section id="about" className="relative py-16 sm:py-24 lg:py-32 bg-black overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-1/4 left-1/4 w-48 sm:w-64 lg:w-96 h-48 sm:h-64 lg:h-96 bg-cyan-500/20 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-48 sm:w-64 lg:w-96 h-48 sm:h-64 lg:h-96 bg-blue-500/20 rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-8">
                <div className="text-center">
                  ...
                  <div className="text-gray-500 text-xs sm:text-sm">Projets crees</div>
                </div>
                <div className="hidden sm:block w-px h-12 sm:h-16 bg-gray-800" />
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-cyan-400 mb-1 sm:mb-2">98%</div>
                  <div className="text-gray-500 text-xs sm:text-sm">Satisfaction</div>
                </div>
                <div className="hidden sm:block w-px h-12 sm:h-16 bg-gray-800" />
                <div className="text-center">
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-800">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="h-24 sm:h-32 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/20 flex items-center justify-center">
                    <Box className="w-12 h-12 sm:w-16 sm:h-16 text-cyan-400/50" />
                  </div>
                  <div className="h-3 sm:h-4 bg-gray-800 rounded w-2/3" />
                  <div className="h-3 sm:h-4 bg-gray-800 rounded w-1/3" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-cyan-500/10 border-y border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 text-center">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">
            Pret a commencer ?
          </h2>
          <p className="text-gray-400 text-sm sm:text-base lg:text-lg mb-6 sm:mb-10">
            Lancez-vous des maintenant et decouvrez la puissance de Novigo3D
          </p>
          <button
            onClick={() => navigate('/plan')}
            className="group inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-10 py-3 sm:py-5 bg-white text-gray-900 rounded-xl font-semibold text-sm sm:text-lg hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-2xl"
          >
      ...
      <footer className="bg-black py-8 sm:py-12 border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center">
                <Box className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
              </div>
              <span className="text-base sm:text-lg font-bold text-white">Novigo<span className="text-cyan-400">3D</span></span>
            </div>
